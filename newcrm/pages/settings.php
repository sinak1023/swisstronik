        ...
        <div class="bg-surface rounded-2xl shadow-sm border border-border p-6">
            ...
            <div class="bg-muted/30 border border-border rounded-xl p-4 mb-4 text-sm text-text/80 leading-relaxed">
                ...
                <ul class="list-disc pr-5 space-y-1">
                    ...
                    <li><b>جلسه به کارشناس:</b> <code dir="ltr">lead</code> (نام لید)، <code dir="ltr">time</code> (ساعت)، <code dir="ltr">date</code> (تاریخ)</li>
                    <li><b>جلسه به مشتری:</b> <code dir="ltr">time</code> (ساعت)، <code dir="ltr">date</code> (تاریخ)</li>
                </ul>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    <label class="block text-sm text-text mb-2">کد پترن یادآور جلسه (کارشناس)</label>
                    <input type="text" name="pattern_meeting_expert" value="<?= htmlspecialchars($s['pattern_meeting_expert'] ?? '') ?>" class="w-full px-4 py-2 border border-border rounded-lg bg-background text-text dir-ltr">
                </div>
                <div>
                    <label class="block text-sm text-text mb-2">کد پترن یادآور جلسه (مشتری)</label>
                    <input type="text" name="pattern_meeting_lead" value="<?= htmlspecialchars($s['pattern_meeting_lead'] ?? '') ?>" class="w-full px-4 py-2 border border-border rounded-lg bg-background text-text dir-ltr">
                </div>
