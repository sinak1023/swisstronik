...
class Reminders
{
    ...
    {
        $sql = "INSERT INTO {$this->table} (lead_id, phone, user_id, reminder_datetime,  reminder_text) VALUES (?, ?, ?, ?, ?)";
        $params = [$data['lead_id'], $data['phone'], $data['user_id'], $data['reminder_datetime'], $data['reminder_text']];
